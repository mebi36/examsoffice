...
from .views import (
    possible_graduands_form,
    result_collation,
    results_menu,
    edit_result,
    student_search_processor,
    find_student,
    student_records,
    add_result,
    result_add_processor,
    recent_results,
    recent_results_bulk,
    delete_result,
    ...
    upload_result_file,
    delete_by_session,
    student_transcript_generator,
    class_speadsheet_generator,
    result_collation_form,
    result_spreadsheet_form,
    student_transcript_form,
    transcript_download_info,
    class_outstanding_courses,
    class_outstanding_courses_form,
    all_results_agg,
    possible_graduands,
