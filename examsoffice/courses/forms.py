...
class CourseForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['course_level'].queryset = LevelOfStudy.objects.filter(level__lte=5)
    ...
    def clean(self):
        ...
        existing_courses_qs = Course.objects.filter(
                        ...
                        credit_load=self.cleaned_data['credit_load']).count()
        if existing_courses_qs > 0:
            self.add_error(None, "Course already exists!!! This is a form error")